...
[国内访问示例 (https://kwnote-code.vercel.app)](https://kwnote-code.vercel.app/) | [Github 部署演示示例 (https://blinkfox.github.io)](https://blinkfox.github.io) 

github分支：[https://github.com/tonywdy/hexo-theme-matery-plus/](https://github.com/tonywdy/hexo-theme-matery-plus/)
gitee分支：[https://gitee.com/KINGWDY_admin/hexo-theme-matery-plus](https://gitee.com/KINGWDY_admin/hexo-theme-matery-plus)
...
点击 [这里](https://gitee.com/KINGWDY_admin/hexo-theme-matery-plus) 下载 `main` 分支的最新稳定版的代码，解压缩后，将 `hexo-theme-matery` 的文件夹复制到你 Hexo 的 `themes` 文件夹中即可。

当然你也可以在你的 `themes` 文件夹下使用 `git clone` 命令来下载:

```bash
git clone https://gitee.com/KINGWDY_admin/hexo-theme-matery-plus.git
```

## 快速上手
> 看完这个后面的插件就不用看了，然后只要建几个页面，配置一下config就行
本主题加入了在线渲染更新，使用vercel自动触发
1.在vercel部署hexo，并配置安装命令：
![](https://gitlab.com/KINGWDY/photobed/-/raw/main/20220816113755.png)
```BATH
npm run deploy && npm install hexo-lazyload-image hexo-generator-feed hexo-wordcount hexo-permalink-pinyin hexo-cli -g hexo-baidu-url-submit hexo-generator-index2 hexo-symbols-count-time hexo-blog-encrypt hexo-deployer-git --save
```
然后重新部署一下，就可以实现！
